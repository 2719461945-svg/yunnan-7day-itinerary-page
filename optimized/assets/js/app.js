...
function dayPhoto(day, index) {
  const src = day.image || `assets/images/yunnan-day${index + 1}.webp`;
  return `
    <figure class="day-photo" data-kind="photo">
      <img src="${text(src)}" alt="${text(day.day)} ${text(day.title)} 旅行图片" width="900" height="1200" loading="lazy" decoding="async">
    </figure>
  `;
}
